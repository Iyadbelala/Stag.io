            ...
            >
              ...
              {isLogin && (
                <div className="my-6 flex items-center gap-3">
                  <div className="h-px flex-1 bg-surface-sand" />
              ...
              {isLogin && (
                <button
                  type="button"
                  className="flex w-full items-center justify-center gap-3 rounded-button border border-surface-sand bg-surface-white py-3.5 text-sm font-medium text-text-primary shadow-sm transition-all hover:bg-surface-cream hover:shadow-md cursor-pointer"
                >
